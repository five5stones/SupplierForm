      ...
      fields: [
        { id: 'documentedFsms', type: 'radio', label: 'Do you operate a documented Food Safety Management System?', required: true, number: 5, options: yesNo },
        {
          ...
          options: [
            ...
            { value: 'SALSA', label: 'SALSA', hint: '*please upload a copy of your certificate in Section 9' },
            { value: 'BRCGS', label: 'BRCGS', hint: '*please upload a copy of your certificate in Section 9' },
      ...
      fields: [
        { id: 'documentTypesHint', type: 'hint', label: 'Please tick all documents you are attaching, then upload files below (PDF, JPG, PNG — max 10MB each, up to 15 files).' },
        {
          ...
          options: [
            ...
            { value: 'SALSA/BRCGS/ISO Certificate', label: 'SALSA/BRCGS/ISO Certificate', hint: '*please provide a copy' },
